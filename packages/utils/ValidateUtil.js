export default {
  ...
  validateUserPass(val) {
    let pwdRegex = new RegExp('(?=.*[0-9])(?=.*[A-Z])(?=.*[a-z])(?=.*[^a-zA-Z0-9]).{8,15}');
  ...
  // 是否包含中文和全角符号
  isChineseCharAndFullwidthChar(str) {
    var reg = /[\u4E00-\u9FA5\uF900-\uFA2D-\uFF00-\uFFEF]/;
    return reg.test(str);
  },
